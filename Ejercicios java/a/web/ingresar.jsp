<%-- 
    Document   : crud
    Created on : 04-06-2021, 04:00:44 PM
    Author     : jared
--%>
...
<html>
    ...
    <body>
        <title>Ingresar Usuarios</title>
        <div class="titulo"> Ingresar Usuarios</div>
        <div class="contenedor">
            <div class="row">
                <h3>Usuarios</h3></div>
            <div class="row col-md-5">
                <form role="form" action="inserBDD.jsp" method="POST">
                    <div class="col-md-10">
                            ...
                            <label for="nombre">ID:</label>
                             <br>
                                <div class="input-group">
                                    <input type="text" class="info" name="Id_Usuario" id="Id_Usuario" placeholder="Ingresa el  nombre" required>
