...
"jdbc:mysql://localhost:6666/Guia8_POO1", "root", "12345");
    ...
    //Capturando los datos por medio del request y el metodo getParameter
      ...
      out.write("        ");
      if (true) {
        _jspx_page_context.forward("ingresaremp.jsp" + "?" + org.apache.jasper.runtime.JspRuntimeLibrary.URLEncode("resultado", request.getCharacterEncoding())+ "=" + org.apache.jasper.runtime.JspRuntimeLibrary.URLEncode("Datos Ingresados Exitosamente", request.getCharacterEncoding()));
        return;
      }
      out.write("\n");
      out.write("    </body>\n");
