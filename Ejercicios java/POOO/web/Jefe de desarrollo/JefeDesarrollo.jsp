<%-- 
    Document   : JefeDesarrollo
    Created on : 04-23-2021, 11:33:35 PM
    Author     : jared
--%>
...
<html lang="en">
    ...
    <body>
        ...
        <sql:query var="sq" dataSource="jdbc/mysql">
            SELECT C.IdCaso, C.DescripcionA, C.IdEstatoCaso, EC.EstadoCaso, EC.IdEstadoCaso from Casos C 
...
<h4>Sino hay casos nose podra visualizar nada </h4>
            <table class="tabla_Depa">
                <thead >
                    <tr>
                        <th class="tabla_titulo">Casos</th>
                ...
                <tbody class="tabla_cuerpo">
                    <c:forEach var="jd" items="${sq.rows}"> 
                        <c:choose >
                            <c:when test="${jd.IdEstadoCaso == 1}">
                                <tr>
                                    <td>  <textarea name="casos" for="casos" readonly="readonly" placeholder=" ${jd.DescripcionA}" maxlength="1000'"></textarea></td>


                                    <td><a href="Aceptar.jsp?id=${jd.IdCaso}" >Aceptar</a> </td>
                                    <td><a href="Rechazar.jsp?id=${jd.IdCaso}" >Rechazar</a> </td>
                                </tr>
                            </c:when>
