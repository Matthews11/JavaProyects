...
<html lang="en">
    ...
    <body>
        ...
        <div class="header">
            ...
            <nav class="menu-main">
                ...
                <a href="Monitorear.jsp" >Monitorear casos</a> 
                  <a href="GenerarPdf.jsp" >Generar Pdf</a> 
        ...
        <div class="contenedor">
            ...
            <form action="${pageContext.request.contextPath}/JAF?accion=ingresar" target="" method="post" name="formDepa">
                ...
                <br>
                <label for="pdf">Suba el Archivo PDF</label>
                <input type="file" name="pdf" id="pdf"/>
                <br>
                <label for="tp"> Departamento</label>
                <select name="depa">
                ...
                <label for="tp"> Seleccione el Jefe de Desarrollo</label>
                <select name="jd">
                ...
                <button   type="submit" name="accion" value="ingresar"> Ingresar </a>
            </form>
