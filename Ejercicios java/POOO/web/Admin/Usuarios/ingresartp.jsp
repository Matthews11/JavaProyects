<%-- 
    Document   : ingresartp
    Created on : 04-27-2021, 11:10:02 PM
    Author     : jared
--%>
...
<html lang="en">
    ...
    <body>
        ...
        <div class="contenedor">
            <div class="cont_user">
                <h2 class="titulo2">Agregar a Departamento</h2>
            <form class="form_user" action="${pageContext.request.contextPath}/Usuarios?accion=ingresartp" target="" method="post" name="formDepa">
                    <div class="user_img">
                        <img src="../img/tester.jpg">
                    </div>
               
                <input class="input_user"type="text" name="DEPA" id="DEPA" placeholder="Ingrese el nombre Usuario"/>
                <br> 
