...
<html lang="en">
    <head>
        ...
        <title>Departamentos | Eliminar</title>
    </head>
    <body>
        ...
        <div class="contenedor">
            <div class="cont_admin">
                ...
                <form  class="form_admin" action="${pageContext.request.contextPath}/departamento?accion=eliminar" target="" method="post" name="formDepa">
                    <div class="user_img">
                    <img src="../img/departamentos.png">
                </div>

                    <input class="input_admin" type="hidden" name="id" id="depa" value="${param.id}"  readonly="readonly" />

                    <input  class="input_admin" type="text" name="depa" id="depa"value="${param.nombre}" readonly="readonly"/>
                    <a class="btn_admin" href="../Administrador.jsp"> Atras</a>
                    <button  class="btn_admin" type="submit" name="accion" value="eliminar"> eliminar </a>
                </form>
            </div>
        </div>
