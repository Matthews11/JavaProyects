...
<html lang="en">
    <head>
        ...
        <title>Departamentos | Modificar</title>
    </head>
    <body>
...
<div class="cont_admin">
    ...
    <h2 class="titulo">Modificar Departamento</h2>
            <form class="form_admin" action="${pageContext.request.contextPath}/departamento?accion=modificar" target="" method="post" name="formDepa">
              
                 <div class="user_img">
                    <img src="../img/departamentos.png">
                </div>
                
                <input  class="input_admin"type="hidden" name="id" id="depa" value="${param.id}"  />
                <input class="input_admin" type="text" name="depa" id="depa"value="${param.nombre}"/>
                <a class="btn_admin" href="../Administrador.jsp"> Atras</a>
                <button   class="btn_admin" type="submit" name="accion" value="modificar"> Modificar </a>
            </form>
