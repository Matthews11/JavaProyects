<%-- 
    ...
    Created on : 04-23-2021, 06:50:31 PM
    Author     : jared
--%>
    ...
    <body>
        ...
        <div class="contenedor">
            ...
            <div class="cont_tabla">
             <h2 class="titulo">Tabla Departamento</h2>
            <sql:query var="q1" dataSource="jdbc/mysql">
                ...
                <table class="tabla_Depa">
                    <thead >
                        <tr>
                           <th class="tabla_titulo">Departamentos</th>
                          <th class="tabla_operaciones"></th>
                    ...
                    <tbody class="tabla_cuerpo">
                        <c:forEach var="depa" items="${q1.rows}">
                            <tr>
                                <td class="nombre_depa"><c:out value="${depa.NombreDepartamento}"/></td> 

                                <td >   <a class="btn_funcion ingre" href='Departamentos/ingresardepa.jsp'>Ingresar</a> </td> 
                                <td >   <a class="btn_funcion mod" href='Departamentos/modificardepa.jsp?id=${depa.IdDepartamento}&nombre=${depa.NombreDepartamento}'>Modificar</a> </td> 
                                <td >   <a class="btn_funcion eli" href='Departamentos/eliminardepa.jsp?id=${depa.IdDepartamento}&nombre=${depa.NombreDepartamento} '>Eliminar</a> </td> 
                            </tr> 
                        </c:forEach>
                    </tbody>
                </table>
