...
<html lang="en">
    ...
    <body>
        ...
        <div class="contenedor">
            <form action="${pageContext.request.contextPath}/JefeDesarrollo?accion=rechazar" target="" method="post" name="formDepa">
                ...
                <label for="mensaje">Razon del rechazo</label>  <br>  <br>
