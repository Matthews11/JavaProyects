<%-- 
    Document   : ModificarProgra
    Created on : 04-14-2021, 07:44:00 PM
    Author     : jared
--%>
    ...
    <body>
        ...
        <div class="contenedor">
            ...
            <div class="row col-md-5">
                <form role="form" action="ModificarPrograBDD.jsp" method="POST">
                    <div class="col-md-10">
                    ...
                    <br>
                                <div class="input-group">
                                    <input type="text" value =" " class="info" name="Id_Progra" id="Id_Progra" placeholder="Ingresa el  nombre" required>
