<%-- 
    Document   : ModificarTester
    Created on : 04-13-2021, 11:58:17 PM
    Author     : jared
--%>
    ...
    <body>
        ...
        <div class="contenedor">
            ...
            <div class="row col-md-5">
                <form role="form" action="ModificarTesterBDD.jsp" method="POST">
                    <div class="col-md-10">
                         ...
                         <div class="form-group">
                            ...
                            <label for="nombre">ID:</label>
                                ...
                                <div class="input-group">
                                    <input type="text" value =" " class="info" name="id_Tester" id="id_Tester" placeholder="Ingresa el  nombre" required>
