<%-- 
    Document   : INP
    Created on : 04-25-2021, 07:49:14 PM
    Author     : jared
--%>
...
<html lang="en">
    <head>
        ...
        <title>Personal | Agregar Programdor</title>
    </head>
    <body>
 ...
 <a href="../Administrador.jsp" >Departamentos</a> 
        ...
        <div class="contenedor">
             <div class="cont_user">
                ...
                <h2 class="titulo">Agregar Programador</h2>
             <form class="form_user" action="${pageContext.request.contextPath}/Personal?accion=ingresar" target="" method="post" name="formDepa">
                <div class="user_img">
                ...
                <br>
                <p class="titulo1" for="numero">Vaya a la tabla usuarios Registre al empleado  para asignar el numero de usuario</p> 
               <br> <p class="titulo1" for="nombre">Numero de usuario</p>
