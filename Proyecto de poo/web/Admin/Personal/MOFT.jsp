<%-- 
    Document   : MOFT
    Created on : 04-25-2021, 07:54:45 PM
    Author     : jared
--%>
...
<html lang="en">
    <head>
        ...
        <title>Personal | Modificar Tester</title>
    </head>
    <body>
    ...
    |           <a href="../Administrador.jsp" >Departamentos</a> 
        ...
        <div class="contenedor">
            <div class="cont_user">
                 <h2 class="titulo">Modificar Tester</h2>
           
                <form class="form_user" action="${pageContext.request.contextPath}/Personal?accion=modificarT" target="" method="post" name="formDepa">
                    <div class="user_img">
                    <img src="../img/usuario.png">
                </div>
                    
                  <input class ="input_login" type="hidden" name="id" id="id" value="${param.id}"  />
                <p class="titulo1" for="nombre">Nombre del Empleado Funcional</label>
