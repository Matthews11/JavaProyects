<%-- 
    Document   : MODP
    Created on : 04-25-2021, 07:50:56 PM
    Author     : jared
--%>
...
<html lang="en">
    <head>
        ...
        <title>Personal | Modificar Programdor</title>
    </head>
    <body>
        ...
        <div class="contenedor">
            <div class="cont_user">
                 <h2 class="titulo">Modificar Programador</h2>
             <form class="form_user" action="${pageContext.request.contextPath}/Personal?accion=modificar" target="" method="post" name="formDepa">
                 <div class="user_img">
                    <img src="../img/usuario.png">
                </div>
                  <input type="hidden" name="id" id="id" value="${param.id}"  />
                <p class="titulo1" for="nombre">Nombre del programador</p>
                <input class ="input_login" type="text" name="nombre" id="nombre" value="${param.nombre}" placeholder="Ingrese el nombre del departamaneto"/>
                <br>
                 <p class="titulo1" for="edad">Edad</p>
                <input class ="input_login" type="text" name="edad" id="edad" value="${param.edad}"placeholder="Ingrese la edad "/>
                <br>
                  <br> 
                 <p class="titulo1" for="correo">Correo</p>
                 <input  class ="input_login" type="email" id="email" name="email"value="${param.correo}" placeholder="Ingrese el correo" pattern="[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*@[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{1,5}">
	    <br>
                 <a class="btn_user" href="../Personal.jsp"> Atras</a>
                <button  class="btn_user" type="submit" name="modificar" value="modificar"> Modificar </a>
            </form>
