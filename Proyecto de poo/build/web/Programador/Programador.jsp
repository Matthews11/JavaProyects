<%-- 
    ...
    Created on : 04-23-2021, 11:33:47 PM
    Author     : jared
--%>
...
<html lang="en">
    ...
    <body>
        ...
        <sql:query var="sq" dataSource="jdbc/mysql">
            SELECT c.DescripcionJ,c.FechaJD, ec.EstadoCaso, c.IdEstatoCaso ,c.IdCaso from Casos c inner join
        ...
        <div class="header">
            ...
            <nav class="menu-main">
                <a href="Programador.jsp"class="active">Casos Asignados</a>
            ...
            <table class="tabla_Depa">
                <thead >
                    <tr>
                        ...
                        <th class="tabla_operaciones">Fecha</th>
                    ...
                    <c:forEach var="jd" items="${sq.rows}"> 
                        <c:choose>
                            ...
                            <c:when test="${jd.IdEstatoCaso==3}">        
                                <tr>
                                    <td>  <c:out value="${jd.DescripcionJ}"/>  </td>
                                    <td>   <c:out value="${jd.FechaJD}"/> </td>
                                    <td>   <c:out value="${jd.EstadoCaso}"/> </td> </td> 
                                    
                                    <td><a href="Bitacora.jsp?id=${jd.IdCaso}" >Trabajar</a> </td>
