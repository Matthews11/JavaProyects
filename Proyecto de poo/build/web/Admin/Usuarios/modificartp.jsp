<%-- 
    ...
    Created on : 04-27-2021, 11:13:03 PM
    Author     : jared
--%>
...
<html lang="en">
    ...
    <body>
        ...
        <div class="contenedor">
            <div class="cont_user">
                <h2 class="titulo2">Modificar Departamento</h2>
            <form class="form_user" action="${pageContext.request.contextPath}/Usuarios?accion=modificartp" target="" method="post" name="formDepa">
                <div class="user_img">
                        <img src="../img/usuario.png">
                    </div>
               
                <input class="input_user" type="hidden" name="id" id="id" value="${param.id}"   />
               
                <input  class="input_user"type="text" name="DEPA" id="DEPA" value="${param.nombre}"   placeholder="Ingrese el nombre Usuario"/>
                <br> 
                <a class="btn_user" href="../Usuarios.jsp"> Atras</a>
                <button  class="btn_user"  type="submit" name="accion" value="modificar"> Modificar </a>
            </form>
                </div>
        </div>
