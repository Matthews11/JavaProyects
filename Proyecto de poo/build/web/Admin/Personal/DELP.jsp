<%-- 
    Document   : DELP
    Created on : 04-25-2021, 07:51:06 PM
    Author     : jared
--%>
...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="../css/normalize.css">
         <title>Personal | Eliminar Programdor</title>
    </head>
    <body>
 ...
 <div class="cont_user">
     <h2 class="titulo">Eliminar Programador</h2>
            <form class="form_user" action="${pageContext.request.contextPath}/Personal?accion=eliminar" target="" method="post" name="formDepa">

                <div class="user_img">
                    <img src="../img/usuario.png">
                </div>
                <input type="hidden" name="id" id="id" value="${param.id}"  readonly="readonly" />
                <p class="titulo1"for="nombre">Nombre del programador</label>
                <input class ="input_login" type="text" name="nombre" id="nombre" value="${param.nombre}"  readonly="readonly" placeholder="Ingrese el nombre del departamaneto"/>
                <br>
                <p class="titulo1"for="edad">Edad</label>
                <input class ="input_login"  type="text" name="edad" id="edad" value="${param.edad}"placeholder="Ingrese la edad " readonly="readonly"/>
                <br>
                <br> 
                <p class="titulo1" for="correo">Correo</label>
                <input class ="input_login"  type="email" id="email" name="email"value="${param.correo}"  readonly="readonly" placeholder="Ingrese el correo" pattern="[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*@[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{1,5}">
                <br>
                <a class="btn_user" href="../Personal.jsp"> Atras</a>
                <button class="btn_user"  type="submit" name="eliminar" value="eliminar"> Eliminar </a>
            </form>
