...
<html lang="en">
    ...
    <body>
        ...
        <sql:query var="sq" dataSource="jdbc/mysql">
            SELECT BD.Titulo, C.DescripcionA , BD.IdCaso, EC.EstadoCaso, C.FechaJD from Casos C
        ...
        <div class="header">
            ...
            <nav class="menu-main">
                <a href="JefeDesarrollo.jsp">Administrar Casos</a>
                <a href="MonitorearP.jsp"class="active" >Monitorear Programador </a>  
