<%-- 
    Document   : Rechazar
    Created on : 05-11-2021, 01:13:09 AM
    Author     : Jared
--%>
    ...
    <body>
        ...
        <div class="header">
         ...
         <div class="contenedor"> 
            ...
            <form class="form_admin" action="${pageContext.request.contextPath}/Testert?accion=Rechazar" target="" method="post" name="formDepa">
                
                
                <input type="hidden" class="info" id="id" name="id" value="${param.id}"   >

                <label class="titulo" for="ob">Observaciones</label>
                <input class="input_admin" type="text" name="Observaciones" id="Observaciones"/>
                 <br>
                <label class="titulo" for="start">Fecha de Limite </label>

                <input  class="input_admin" type="date" id="fecha" name="fecha"
                       value="2021-05-12"
