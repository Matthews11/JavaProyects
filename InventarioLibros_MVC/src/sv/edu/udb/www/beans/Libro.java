...
public class Libro {
	...
	public Libro(String codigoLibro, String nombreLibro, int existencias, double precio, Autor autor,
			Editorial editorial, Genero genero, String descripcion, String codigoAutor, String codigoEditorial,
			int idGenero) {
