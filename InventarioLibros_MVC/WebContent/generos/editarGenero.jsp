	...
	<div class="container">
		...
		<div class="row">
			<div class=" col-md-7">
				...
				<form role="form" action="${pageContext.request.contextPath}/generos.do" method="POST">
					...
					<div class="form-group">
						...
						<div class="input-group">
							<input type="hidden" class="form-control" value="${genero.idGenero}" name="codigo" id="codigo"  readonly
					...
					<div class="form-group">
						...
						<div class="input-group">
							<input type="text" class="form-control" id="descripcion"
								value="${genero.descripcion}" name="descripcion"
								placeholder="Ingresa la descripcion del genero: "> <span
								class="input-group-addon"><span
								class="glyphicon glyphicon-asterisk"></span></span>
						</div>
					</div>
					...
					<input type="submit" class="btn btn-info" value="Guardar"
						...
						href="${pageContext.request.contextPath}/generos.do?op=listar">Cancelar</a>
				</form>
			</div>
		</div>
	</div>
